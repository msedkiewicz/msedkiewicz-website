    ...
    <>
      ...
      <Container className={styles.homepagecontainer}>
        <Row className={styles.homepagerow}>
          <HeroDescription><h1>MSedkiewicz</h1><h2>web developer po psychologii</h2>
          <p>Do IT ciągnęło mnie jeszcze zanim rozpoczęłam studia na kierunku General Psychology. Po latach zdobywania doświadczenia dziennikarskiego, copywriterskiego, pisarskiego, psychologicznego oraz szermierczego spełniło się moje marzenie o wejściu do IT.</p>
