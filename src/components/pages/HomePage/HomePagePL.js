    ...
    <>
      ...
      <Container className={styles.homepagecontainer}>
        <Row className={styles.homepagerow}>
          ...
          <p>Do IT ciągnęło mnie jeszcze zanim rozpoczęłam studia na kierunku General Psychology. Swoją pierwszą stronę na WordPressie postawiłam w 2011 roku. Od tego momentu w wolnym czasie zajmowałam się stronami rodziny i znajomych</p>
          <p>Po latach zdobywania doświadczenia dziennikarskiego, copywriterskiego, pisarskiego, psychologicznego oraz szermierczego spełniłam moje marzenie o wejściu do IT.</p>
